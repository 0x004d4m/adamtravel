...
Route::group([
    ...
    Route::crud('account-category-type', 'AccountCategoryTypeCrudController');
    Route::crud('account-category', 'AccountCategoryCrudController');
    ...
    Route::crud('route-groups', 'RouteGroupsCrudController');
